...
- Fixed regressions:
  - stale TF-IDF index state in [`brain.py`](/mnt/c/jarvis/brain.py)
  - prompt retrieval scope expectation in [`web.py`](/mnt/c/jarvis/web.py)
...
- Python: `3.10.12`
- Jarvis checkout: `/workspace/jarvis`
...
- Added reusable Playwright smoke files:
  - [`playwright.config.js`](/mnt/c/jarvis/playwright.config.js)
  - [`smoke.spec.js`](/mnt/c/jarvis/qa/playwright/smoke.spec.js)
...
## Deployment Notes
- [`redeploy.sh`](/mnt/c/jarvis/redeploy.sh) now supports host and port overrides and preserves remote secrets by excluding `config_local.py`.
